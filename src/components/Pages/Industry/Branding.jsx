                ...
                return (
                  ...
                  >
                    <Heading
                      ...
                      Txt={item.value}
                      className={
                        " font-filson text-[80px] font-bold leading-[120%] tracking-[-0.04] text-primary-white group-hover:text-primary-green ease-in-out duration-500  "
                      }
                    />
                    <Paragraph
                      Txt={item.title}
                      className={
                        "text-xl text-primary-light-white font-bold leading-[150%] group-hover:text-primary-green ease-in-out duration-500 "
                      }
                    />
                  </div>
                );
